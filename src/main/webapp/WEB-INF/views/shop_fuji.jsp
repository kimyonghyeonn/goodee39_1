				...
				<div class="col-lg-5 mt-5">
					<div class="card mb-3">
						<img class="card-img img-fluid"
							src="${pageContext.request.contextPath}/resources/assets/img/fuji1.JPG"
							...
							<div class="carousel-inner product-links-wap" role="listbox">
								...
								<div class="carousel-item active">
									<div class="row">
										...
										<div class="col-4">
											<a href="#"> <img class="card-img img-fluid"
												src="${pageContext.request.contextPath}/resources/assets/img/fuji2.JPG"
												alt="Product Image 2">
											</a>
										</div>
										<div class="col-4">
											<a href="#"> <img class="card-img img-fluid"
												src="${pageContext.request.contextPath}/resources/assets/img/fuji3.JPG"
												alt="Product Image 3">
											</a>
										</div>
									</div>
								...
								<div class="carousel-item">
									<div class="row">
										<div class="col-4">
											<a href="#"> <img class="card-img img-fluid"
												src="${pageContext.request.contextPath}/resources/assets/img/fuji4.JPG"
												alt="Product Image 4">
											</a>
										</div>
										<div class="col-4">
											<a href="#"> <img class="card-img img-fluid"
												src="${pageContext.request.contextPath}/resources/assets/img/fuji5.JPG"
												alt="Product Image 5">
											</a>
										</div>
										<div class="col-4">
											<a href="#"> <img class="card-img img-fluid"
												src="${pageContext.request.contextPath}/resources/assets/img/fuji6.JPG"
												alt="Product Image 6">
											</a>
										</div>
									</div>
								...
								<div class="carousel-item">
									<div class="row">
										<div class="col-4">
											<a href="#"> <img class="card-img img-fluid"
												src="${pageContext.request.contextPath}/resources/assets/img/fuji7.JPG"
												alt="Product Image 7">
											</a>
										</div>
										<div class="col-4">
											<a href="#"> <img class="card-img img-fluid"
												src="${pageContext.request.contextPath}/resources/assets/img/fuji8.JPG"
												alt="Product Image 8">
											</a>
										</div>
										<div class="col-4">
											<a href="#"> <img class="card-img img-fluid"
												src="${pageContext.request.contextPath}/resources/assets/img/fuji9.JPG"
												alt="Product Image 9">
											</a>
										</div>
									</div>
			...
			<div id="carousel-related-product">
				...
				<div class="p-2 pb-3">
					<div class="product-wap card rounded-0">
							...
							<div
								...
								<ul class="list-unstyled">
									...
									<li><a class="btn btn-success text-white mt-2"
										href="shop_codak.html"><i class="far fa-eye"></i></a></li>
									<li><a class="btn btn-success text-white mt-2"
										href="cart.html"><i class="fas fa-cart-plus"></i></a></li>
								</ul>
							</div>
						</div>
						...
						<div class="card-body">
							...
							<a href="shop_codak.html" class="h3 text-decoration-none">Codak
								film</a>
							<ul
				...
				<div class="p-2 pb-3">
					<div class="product-wap card rounded-0">
							...
							<div
								...
								<ul class="list-unstyled">
									<li><a class="btn btn-success text-white"
										href="shop-single.html"><i class="far fa-heart"></i></a></li>
									<li><a class="btn btn-success text-white mt-2"
										href="shop_b&w.html"><i class="far fa-eye"></i></a></li>
									<li><a class="btn btn-success text-white mt-2"
										href="cart.html"><i class="fas fa-cart-plus"></i></a></li>
								</ul>
							</div>
						...
						<div class="card-body">
							<a href="shop_b&w.html" class="h3 text-decoration-none">B&W
								film</a>
							<ul
								class="w-100 list-unstyled d-flex justify-content-between mb-0">
								<!-- <li>M/L/X/XL</li> -->
				...
				<div class="p-2 pb-3">
					<div class="product-wap card rounded-0">
							...
							<div
								...
								<ul class="list-unstyled">
									<li><a class="btn btn-success text-white"
										href="shop-single.html"><i class="far fa-heart"></i></a></li>
									<li><a class="btn btn-success text-white mt-2"
										href="shop_expired.html"><i class="far fa-eye"></i></a></li>
									<li><a class="btn btn-success text-white mt-2"
										href="cart.html"><i class="fas fa-cart-plus"></i></a></li>
								</ul>
							</div>
						...
						<div class="card-body">
							<a href="shop_expired.html" class="h3 text-decoration-none">Expired
								film</a>
							<ul
								class="w-100 list-unstyled d-flex justify-content-between mb-0">
								<!-- <li>M/L/X/XL</li> -->
				...
				<div class="p-2 pb-3">
					<div class="product-wap card rounded-0">
							...
							<div
								...
								<ul class="list-unstyled">
									<li><a class="btn btn-success text-white"
										href="shop-single.html"><i class="far fa-heart"></i></a></li>
									<li><a class="btn btn-success text-white mt-2"
										href="shop_digital.html"><i class="far fa-eye"></i></a></li>
									<li><a class="btn btn-success text-white mt-2"
										href="cart.html"><i class="fas fa-cart-plus"></i></a></li>
								</ul>
							</div>
						...
						<div class="card-body">
							<a href="shop_digital.html" class="h3 text-decoration-none">디지털
								인화 / 스캔</a>
							<ul
								class="w-100 list-unstyled d-flex justify-content-between mb-0">
								<!-- <li>M/L/X/XL</li> -->
...
<script>
        ...
        var amountIndex = document.getElementById("amount").options.selectedIndex;
        var amountvalue = amount.options[amountIndex].value;
        
/* 		$(function(){
			$("#delete").click(function(){
				if(confirm("정말로 삭제하시겠습니까")){
					location.href = "${pageContext.request.contextPath }/cart/insert_cart_list?product_num=${productVO.product_num }&num=${sessionScope.account.num }&amount=amountvalue";
