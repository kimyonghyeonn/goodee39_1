...
<div class="feedback">
<p>${bbsVO.ownername }님</p><br />
항상 저희 Film Storage의 서비스를 이용해주셔서 감사합니다. 해당 제품에 대해 만족하셨나요? 저희 서비스에 문제가 있거나, 바라는 점이 있다면 해당 페이지의 리뷰를 남겨주세요.</p>
...
<label>1. 제품에 대해 전반적으로 만족스러우신가요?</label><br>
...
<form:radiobutton path="productscore" value="5"/><i></i>
  ...
  <div class="clear"></div> 
  <hr class="survey-hr">
<label>2. 배송 과정은 만족스러우셨나요?</label><br>
<span class="star-rating">
...
<form:radiobutton path="deleveryscore" value="5"/><i></i>
  ...
  <div class="clear"></div> 
  <hr class="survey-hr">
<label>3. 상담원의 서비스는 만족스러우셨나요? </label><br><br/>
...
<span class="scale-rating">
  ...
  <hr class="survey-hr"> 
  <label for="m_3189847521540640526commentText">4. 리뷰제목:</label><br/><br/>
...
<label for="m_3189847521540640526commentText">4. 리뷰내용: 바라는 점이나 문의가 있다면 남겨주세요:</label><br/><br/>
...
<input type="button" id="modify" style="background:#59ab6e;color:#fff;padding:12px;border:0"  value="리뷰 수정하기">&nbsp;
<input type="button" id="delete" style="background:#59ab6e;color:#fff;padding:12px;border:0" value="리뷰 삭제하기" >&nbsp;

<!--   <button id="modify" style="background:#59ab6e;color:#fff;padding:12px;border:0">리뷰 수정하기</button>&nbsp;
  <button  id="delete" style="background:#59ab6e;color:#fff;padding:12px;border:0">리뷰 삭제하기</button>&nbsp; -->
...
<div class="ScriptTop">
  <div class="rt-container">
      ...
      <div class="col-rt-2">
          <ul>
              <li><a href="index.html" title="Back to tutorial page">메인 페이지로 돌아가기</a></li>
          </ul>
      </div>
  </div>
</div>
