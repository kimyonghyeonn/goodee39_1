...
<body>
	...
	<section id="registration-page">
		...
		<form:form modelAttribute="memberVO"
			action="${pageContext.request.contextPath }/admin/admin_userupdateconfirm"
			class="signup-form">
			<!-- FORM HEADER -->
			...
			<div class="form-body">
				...
				<div class="row">
					<div style="display: flex;">
						<label>관리자 계정 지정</label>





						<form:input path="role" placeholder="관리자일 경우 admin 입력"
							id="phone_num" type="text" style="width: 200px" />
