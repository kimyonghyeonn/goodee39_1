...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/assets/css/myinfo.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/assets/css/coupon.css">
<link rel="stylesheet"
		...
		<div class="content">
			<form action="#">
				<div class="user-details">
					<div class="input-box">
						<span class="details">성</span> <input type="text"
							placeholder="성을 입력해주세요" required>
					</div>
					<div class="input-box">
					...
					<div class="input-box">
						<span class="details">Email(ID)</span> <input type="text"
							placeholder="ID가 될 이메일 주소를 입력해주세요" required>
					</div>
					<div class="input-box">
						<span class="details">휴대폰 번호</span> <input type="text"
							placeholder="010-0000-0000 형식으로 입력해주세요." required>
					</div>
					<div class="input-box">
						<span class="details">비밀번호</span> <input type="text"
							placeholder="앞으로 쓰일 비밀번호를 입력해주세요." required>
					</div>
					<div class="input-box">
						<span class="details">비밀번호 확인</span> <input type="text"
							placeholder="수정한 비밀번호를 다시 입력해주세요." required>
					</div>
				</div>
				...
				<div class="full_input_box">
					<span class="details">기본 주소</span> <br> <input type="text"
						placeholder="시/군/구 까지의 주소를 입력해주세요." required>

				</div>

				<div class="full_input_box">
					<span class="details">상세 주소</span> <br> <input type="text"
						placeholder="시/군/구 이하의 자세한 주소를 입력해주세요." required>
		...
		<div class="row">
            ...
            <time datetime="23th feb"> -->
				...
				<section class="card-cont">
					...
					<h3>Fuji C200 20% Dicount</h3>
					<div class="even-date">
						<i class="fa fa-calendar"></i>
						<time>
							<span>2021년 12월 31일</span> <span>~24:00시까지 유효합니다.</span>
						</time>
					</div>
					<div class="even-info">
						<i class="fa fa-map-marker"></i>
						<p>온라인 매장에서만 사용 가능하며, 재사용이 불가합니다.</p>
					</div>
					<a href="#">Coupon</a>
				</section>
			</article>
            ...
            <time datetime="23th feb">
              <span>23</span><span>feb</span>
				...
				<section class="card-cont">
					<!-- <small>dj khaled</small> -->
					<h3>Codak gold 20% Discount</h3>
					<div class="even-date">
						<i class="fa fa-calendar"></i>
						<time>
							<span>2021년 12월 31일</span> <span>~24시까지 유효합니다.</span>
						</time>
					</div>
					<div class="even-info">
						<i class="fa fa-map-marker"></i>
		...
		<div class="row">
            ...
            <time datetime="23th feb">
              <span>23</span><span>feb</span>
				...
				<section class="card-cont">
					<!-- <small>dj khaled</small> -->
					<h3>Expired Film 20% Discount</h3>
					<div class="even-date">
						<i class="fa fa-calendar"></i>
						<time>
							<span>~2021년 12월 31일</span> <span>24시까지 유효합니다.</span>
					...
					<div class="row">
						...
						<div class="col-md-6 col-lg-3">
							<div class="footer-links">
								<h3>Navigator</h3>
								<a href="shop.html">Shop</a> <a href="gallery_content.html">Brand
