		...
		<div class="rt-container">
			<div class="col-rt-12">
				<div class="Scriptcontent">
					...
					<div class="feedback">
						<p>
							리뷰생성페이지입니다.<br> 항상 저희 Film Storage의 서비스를 이용해주셔서 감사합니다. 해당
							제품에 대해 만족하셨나요? 저희 서비스에 문제가 있거나, 바라는 점이 있다면 해당 페이지의 리뷰를 남겨주세요.
						</p>
						...
						<form:form modelAttribute="BBSVO"
							action="${pageContext.request.contextPath }/bbs/review_create_result">
