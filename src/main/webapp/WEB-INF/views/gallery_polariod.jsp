...
<body style="background-color: #111;">
	...
	<div id="gal_title">
        ...
        <p class="m-flip js-flip" style="font-size: 30px; font-family:'Permanent Marker', cursive;">
			...
			<p class="m-flip js-flip" style="font-size: 10px;">
				<span class="m-flip_item">전 세계에 단 한장 뿐</span> <span
					class="m-flip_item">Polaroid</span>
			</p>
		</div>
	</div>
	...
	<section class="photo-grid-container">
		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_polaroid/gal_pol1.JPG"
				alt="">
		...
		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_polaroid/gal_pol2.jpg"
				alt="" />
		</div>
		...
		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_polaroid/gal_pol3.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_polaroid/gal_pol4.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_polaroid/gal_pol5.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_polaroid/gal_pol6.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_polaroid/gal_pol7.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_polaroid/gal_pol8.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_polaroid/gal_pol9.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_polaroid/gal_pol10.jpg"
				alt="" />
		...
		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_polaroid/gal_pol11.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_polaroid/gal_pol12.jpg"
				alt="" />
		</div>
		...
		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_polaroid/gal_pol14.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_polaroid/gal_pol15.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_polaroid/gal_pol16.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_polaroid/gal_pol17.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_polaroid/gal_pol18.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_polaroid/gal_pol19.jpg"
				alt="" />
