		...
		<div class="rt-container">
			<div class="col-rt-12">
				<div class="Scriptcontent">
					...
					<div class="feedback">
						<p>
							고객님께,<br> 항상 저희 Film Storage의 서비스를 이용해주셔서 감사합니다. 해당 제품에 대해
							만족하셨나요? 저희 서비스에 문제가 있거나, 바라는 점이 있다면 해당 페이지의 리뷰를 남겨주세요.
						</p>
						...
						<form:form modelAttribute="BBSVO"
							action="${pageContext.request.contextPath }/bbs/review_list">

							<label>1. 제품에 대해 전반적으로 만족스러우신가요?</label>
							<br>

							<span class="star-rating"> <form:radiobutton
									path="productscore" value="1" /><i></i> <form:radiobutton
									path="productscore" value="2" /><i></i> <form:radiobutton
									path="productscore" value="3" /><i></i> <form:radiobutton
									path="productscore" value="4" /><i></i> <form:radiobutton
									path="productscore" value="5" /><i></i>
							...
							<span class="star-rating"> <form:radiobutton
									...
									path="deleveryscore" value="5" /><i></i>
							</span>
							...
							<span class="scale-rating"> <label value="1"> <form:radiobutton
									...
									style="width: 100%;"></label>
										...
										value="1" name="rating" /> <label style="width: 100%;"></label>
							...
							<div class="clear"></div>
							<form:button
								style="background:#59ab6e;color:#fff;padding:12px;border:0"
								type="submit">리뷰 작성하기</form:button>&nbsp;
