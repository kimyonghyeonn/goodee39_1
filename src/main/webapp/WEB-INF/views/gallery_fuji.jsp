...
<body style="background-color: #111;">
	...
	<div id="gal_title">
		...
		<div id="app">
			...
			<p class="m-flip js-flip" style="font-size: 10px;">
				<span class="m-flip_item">80년 전통의 필름 노하우</span> <span
					class="m-flip_item">Fuji film x-s10</span>
			</p>
		</div>
	</div>
	...
	<section class="photo-grid-container">
		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_fuji/gal_fuji1.jpg"
				alt="">
		...
		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_fuji/gal_fuji2.jpg"
				alt="" />
		</div>
		...
		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_fuji/gal_fuji3.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_fuji/gal_fuji4.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_fuji/gal_fuji5.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_fuji/gal_fuji6.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_fuji/gal_fuji7.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_fuji/gal_fuji8.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_fuji/gal_fuji9.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_fuji/gal_fuji10.jpg"
				alt="" />
		...
		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_fuji/gal_fuji11.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_fuji/gal_fuji12.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_fuji/gal_fuji13.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_fuji/gal_fuji14.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_fuji/gal_fuji15.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_fuji/gal_fuji16.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_fuji/gal_fuji17.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_fuji/gal_fuji18.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_fuji/gal_fuji19.jpg"
				alt="" />
...
<body>
	...
	<script src="./assets/js/gel_title.js"></script>
	<!-- End Script -->
</body>
</html>
