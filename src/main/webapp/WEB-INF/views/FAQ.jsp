	...
	<section
		...
		<div class="cd-faq__items">
			<ul id="basics" class="cd-faq__group">
				...
				<li class="cd-faq__item"><a class="cd-faq__trigger" href="#0"><span>비밀번호는
							어떻게 변경하나요?</span></a>
					<div class="cd-faq__content">
						<div class="text-component">
							<p>비밀번호는 좌측의 사람모양 아이콘을 클릭하면 마이페이지로 이동합니다. 마이페이지에서 아이디, 비밀번호
								등의 개인정보를 수정할 수 있습니다.</p>
						</div>
					</div></li>

				<li class="cd-faq__item"><a class="cd-faq__trigger" href="#0"><span>회원가입은
							어떻게 하나요?</span></a>
					<div class="cd-faq__content">
						<div class="text-component">
							<p>회원가입은 상단의 Sign in을 클릭해서 할 수 있습니다.</p>
						</div>
					</div></li>

				<li class="cd-faq__item"><a class="cd-faq__trigger" href="#0"><span>리뷰
							게시물을 지울 수 있나요?</span></a>
					<div class="cd-faq__content">
						<div class="text-component">
							<p>좌측의 사람모양 아이콘을 클릭하면 마이페이지로 이동합니다. 마이페이지에서 고객님이 작성하신 리뷰를 수정,
								삭제할 수 있습니다.</p>
						</div>
					</div></li>

				<li class="cd-faq__item"><a class="cd-faq__trigger" href="#0"><span>회원탈퇴는
							어떻게 하나요?</span></a>
					<div class="cd-faq__content">
						<div class="text-component">
							<p>좌측의 사람모양 아이콘을 클릭해서 회원탈퇴를 할 수 있습니다.
						</div>
					</div></li>
			</ul>
			...
			<ul id="mobile" class="cd-faq__group">
				...
				<li class="cd-faq__item"><a class="cd-faq__trigger" href="#0"><span>모바일에서도
							웹을 볼 수 있나요?</span></a>
					<div class="cd-faq__content">
						<div class="text-component">
							<p>해당 사이트는 모든 페이지가 데스크탑, 테블릿, 모바일 스마트폰에서 볼 수 있도록 반응형 웹으로 작성되어
								있습니다.</p>
						</div>
					</div></li>

				<li class="cd-faq__item"><a class="cd-faq__trigger" href="#0"><span>창이
							안떠요ㅡ 어떻게 해야하나요?</span></a>
					<div class="cd-faq__content">
						<div class="text-component">
							<p>페이지가 뜨지 않는다면 창을 닫고 다시 시도해주세요.</p>
						</div>
					</div></li>

				<li class="cd-faq__item"><a class="cd-faq__trigger" href="#0"><span>다른
							리뷰 게시물도 볼 수 있나요?</span></a>
					<div class="cd-faq__content">
						<div class="text-component">
							<p>본인이 작성자라면 볼 수 있습니다. 다른사람도 볼 수 있지만 수정, 삭제는 암호를 입력해서 조작할 수
								있습니다.</p>
						</div>
					</div></li>
			</ul>
					...
					<div class="cd-faq__content">
						<div class="text-component">
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
								...
								Dolore, quo amet nostrum autem nemo. Sit nam assumenda, corporis
								ea sunt distinctio nostrum doloribus alias, beatae nesciunt
								dolore saepe consequuntur minima eveniet porro dolor officiis
								maiores ab obcaecati officia enim aliquam. Itaque fuga molestiae
								hic accusantium atque corporis quia id sequi enim vero? Hic
								aperiam sint facilis aliquam quia, accusamus tenetur earum totam
								enim est, error. Iusto, reiciendis necessitatibus molestias.
...
<body>
	...
	<script
		src="${pageContext.request.contextPath}/resources/assets/js/faq_util.js"></script>
	<!-- util functions included in the CodyHouse framework -->
	<script
		src="${pageContext.request.contextPath}/resources/assets/js/faq_main.js"></script>
</body>
</html>