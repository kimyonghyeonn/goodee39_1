...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/assets/css/sidebar_gal.css">
...
<body style="background-color: #111;">
	...
	<main>
		...
		<nav class="floating-menu">
			<ul class="main-menu">
				<li><a href="index.html" class="ripple"> <i
						class="fas fa-home fa-lg"></i>
				</a></li>
				<li><a href="myinfo.html" class="ripple"> <i
						class="far fa-user fa-lg"></i>
				</a></li>
	...
	<div id="gal_title">
		...
		<div id="app">
			...
			<p class="m-flip js-flip" style="font-size: 10px;">
				<span class="m-flip_item">엘리자베스 여왕의 카메라</span> <span
					class="m-flip_item">Rollei 35</span>
			</p>
		</div>
	</div>
	...
	<section class="photo-grid-container">
		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_rollei/gal_rollei1.jpg"
				alt="">
		...
		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_rollei/gal_rollei2.jpg"
				alt="" />
		</div>
		...
		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_rollei/gal_rollei3.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_rollei/gal_rollei4.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_rollei/gal_rollei5.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_rollei/gal_rollei6.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_rollei/gal_rollei7.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_rollei/gal_rollei8.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_rollei/gal_rollei9.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_rollei/gal_rollei10.jpg"
				alt="" />
		...
		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_rollei/gal_rollei11.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_rollei/gal_rollei12.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_rollei/gal_rollei13.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_rollei/gal_rollei14.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_rollei/gal_rollei15.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_rollei/gal_rollei16.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_rollei/gal_rollei17.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_rollei/gal_rollei18.jpg"
				alt="" />
		</div>

		<div class="photo-grid-item">
			<img
				src="${pageContext.request.contextPath}/resources/assets/img/gallery_rollei/gal_rollei19.jpg"
				alt="" />
