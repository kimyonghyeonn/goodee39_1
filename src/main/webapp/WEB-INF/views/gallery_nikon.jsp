...
<body style="background-color: #111;">
	...
	<div id="gal_title">
		...
		<div id="app">
			<p class="m-flip js-flip"
				style="font-size: 150px; font-family: Abel; font-weight: bold;">
				<span class="m-flip_item">일본 광학기술의 집약체</span> <span
					class="m-flip_item">Nikon FM2</span>
			</p>
